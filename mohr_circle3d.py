...
def plot_mohr3d(S):
    ...
    circ1 = plt.Circle((cent_maj,0), R_maj*0.85, facecolor='#cce885', lw=3,
                   edgecolor='#5c8037')
    circ2 = plt.Circle((cent_min,0), R_min*0.85, facecolor='w', lw=3,
                   edgecolor='#15a1bd')
    circ3 = plt.Circle((cent_mid,0), R_mid*0.85, facecolor='w', lw=3,
                   edgecolor='#e4612d')
    ...
    plt.xlabel(r"Ứng suất $\sigma$", size=12)
    plt.ylabel(r"Sức căng $\tau$", size=12)
